...
function pass1Valid () {
    ...
    var pswd = document.getElementById("pass");
    if (pswd.value !== pswd1.value) { //if both mismatch.
...
function stateValid () {
    ...
    if (state){
        if (state.value === "Select State" || state.value.length > 52) { //if empty
...
function martialValid () {
    if(document.getElementById('married').checked) {
        var martial = document.getElementById("single");
        ...
        var martial = document.ggetElementById("single");
        martialDiv.classList.remove("is-invalid");
        martialDiv.classList.add("is-valid");
        var martialErr = document.getElementById("martialErr");
        martialErr.classList.add("d-none");
        ...
        if (martialDiv) {
            martialDiv.classList.add("is-invalid");
