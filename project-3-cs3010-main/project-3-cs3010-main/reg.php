        ...
        <form method="post" novalidate action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            <div class="row">
                <div class="col border rounded w3-dark-grey mb-3">
                    <div class="form-group">
                        ...
                        <div id="usrErr" class="text-danger"><?php echo $usrErr;?></div>
                    </div>
                    <div class="form-group">
                        ...
                        <div id="passErr" class="text-danger"><?php echo $passErr;?></div>
                    </div>
                    <div class="form-group">
                        ...
                        <div id="pass1Err" class="text-danger"><?php echo $pass1Err;?></div>
                    </div>
                </div>
                <div class="col border rounded w3-dark-grey mb-3">
                    <div class="form-group">
                        ...
                        <div id="fnameErr" class="text-danger"><?php echo $fnameErr;?></div>
                    </div>
                    <div class="form-group">
                        ...
                        <div id="lnameErr" class="text-danger"><?php echo $lnameErr;?></div>
                    </div>
                    <div class="form-group">
                        <label for="pnum" class="form-label">Phone Number</label>
                        <p><input class="form-control p-2" type="tel" id="pnum" placeholder="123-456-7890"  required name="pnum" value="<?php echo $pnum;?>"></p>
                        <div id="numErr" class="text-danger"><?php echo $numErr;?></div>
                    </div>
                    <div class="form-group">
                        <label for="email" class="form-label">Email</label>
                        <p><input class="form-control p-2" type="text" id="email" placeholder="Email" required name="Email" value="<?php echo $email;?>"></p>
                        <div id="emailErr" class="text-danger"><?php echo $emailErr;?></div>
                    </div>
                </div>
                <div class="col border rounded w3-dark-grey mb-3">
                    <div class="form-group">
                        ...
                        <div id="addr1Err" class="text-danger"><?php echo $addr1Err;?></div>
                    </div>
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col border rounded w3-dark-grey mb-3" id="gender">
                    ...
                    <div id="genderErr" class="text-danger"><?php echo $genderErr; ?></div>
                </div>
                <div class="col border rounded w3-dark-grey mb-3" id="martial">
                    <h4>Select Marital Status:</h4>
                    <label for="married" class="form-check-label">Married</label>
                    <input class="form-check-input" type="radio" id="married" name="martial" <?php if ($martial=="married"){echo "checked";} ?> value="married" required>

                    <label for="divorced" class="form-check-label">Divorced</label>
                    <input class="form-check-input" type="radio" id="divorced" name="martial" <?php if ($martial=="divorced"){echo "checked";} ?> value="divorced" required>

                    <label for="single" class="form-check-label">Single</label>
                    <input class="form-check-input" type="radio" id="single" name="martial" <?php if ($martial=="single"){echo "checked";} ?> value="single" required>
                    <div id="martialErr" class="text-danger"><?php echo $martialErr; ?></div>
                </div>
                <div class="col border rounded w3-dark-grey mb-3">
                    <h3>Pick Date of Birth:</h3>
                    <label for="date" class="form-label"></label>
                    <input type="date" id="date" name="date" required>
                    <div id="dateErr" class="text-danger"><?php echo $dateErr; ?></div>
                </div>
            </div>
